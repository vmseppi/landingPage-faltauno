  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-custom-gradient">
        ...
        <header
          className="relative min-h-[418px] md:min-h-[600px] md:max-h-[767px] flex items-center justify-center backdrop-blur-sm"
          style={{
        ...
        >
          <div className="container mx-auto px-7 md:px-48 py-8 md:py-48 flex flex-col items-center md:items-start relative z-10">
            <div className="max-w-[740px] flex flex-col items-center md:flex md:items-start">
              ...
              <div className="md:hidden">
                <div className="text-center mb-12">
                  <p className="font-lexend font-medium text-sm leading-7 text-black mb-6">
                    Con <span className="font-bold text-[#086EC1]">FALTA</span>
                    <span className="text-[#03DAC5] font-bold">UNO</span> crea
        ...
        <footer
          className="w-[390px] h-[298px] md:w-full mx-auto flex items-center justify-center backdrop-blur-sm md:pb-[100px] md:py-10"
          style={{
        ...
        >
          <div className="container mx-auto text-center px-7 relative z-10 flex flex-col items-center">
            <h2 className="font-lexend font-black text-[22px] leading-7 text-white mb-8 relative z-10 md:hidden">
              Empieza a jugar <br />
              hoy mismo.
            </h2>
            <h2 className="hidden md:block font-lexend font-black text-[22px] leading-7 text-white relative z-10 md:my-[100px]">
